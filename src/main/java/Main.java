...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        myBook.put("Mikhail", 1909);
        myBook.put("Mikhail", 1444);
        myBook.put("Mikhail", 4545);
        myBook.put("Mikhail", 9995);
        myBook.put("Ivan", 8909);
        myBook.put("Ivan", 1212);
        myBook.put("Valera", 1312);
        myBook.getPhoneBook();
    }
}

class PhoneBook {
    private final HashMap<String, ArrayList<Integer>> phoneBook = new HashMap<>();
